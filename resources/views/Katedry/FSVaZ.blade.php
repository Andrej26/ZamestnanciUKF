            ...
            <main class="main-content">
                <div class="content">
                    ...
                    <div class="feature-icon" >
                        <h3 class="feature-title">Dekanát FSVaZ </h3>
                    </div>

                    <div class="feature-icon" >
                        <h3 class="feature-title">Katedra klin. disc. a urg. med. </h3>
                    </div>

                    <div class="feature-icon" >
                        <h3 class="feature-title">Katedra ošetrovateľstva </h3>
                    </div>

                    <div class="feature-icon" >
                        <h3 class="feature-title">Katedra psychologických vied </h3>
                    </div>

                    <div class="feature-icon" >
                        <h3 class="feature-title">Katedra soc. práce a soc. vied </h3>
                    </div>

                    <div class="feature-icon" >
                        <h3 class="feature-title">Ústav aplikovanej psychológie </h3>
                    </div>

                    <div class="feature-icon" >
                        <h3 class="feature-title">Ústav romologických štúdií </h3>
                    </div>
