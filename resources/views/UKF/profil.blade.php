        ...
        <div class="container">
            ...
            <div class="komentar" >
                ...
                @foreach ($komentare as $kom)
                    <div class="komentare">
                        <div class="autor" >
                            <a href="{{route('profil', $kom->idzamestnanec)}}"><img id="student-image" src="{{URL::to('/')}}/{{ \App\Http\Controllers\UploadController::VratObrazokZamestnanca($kom['id'])}}" alt="Profilova Fotografia" height="25%" width="auto" style="border-radius: 50%"></a>
                        </div>
