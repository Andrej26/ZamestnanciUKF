<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #3a454b; border-radius: 0px 0px 6px 6px">
    <a class="navbar-brand" href="{{route('zames.dashboard')}}"><i class="fa fa-home" aria-hidden="true" style="font-size: 160%"></i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto">
                <li>
                    <form class="form-inline my-2 my-lg-0" action="{{URL::to('Zamestnanec/getfulltextresultsAsEmp')}}">
                        <input class="form-control mr-sm-2" type="search" placeholder="Hľadať" aria-label="Search" id="fulltext_input" name="fulltext_input_emp">
