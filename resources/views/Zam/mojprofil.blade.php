        ...
        <div class="container">
                                ...
                                <div class="student-details">
                                    ...
                                    <ul class="student-info">
                                        ...
                                        @if($prof['id'] != null && $prof['id'] > 0)
                                            <li><p> <strong>Upravenie profilu:</strong>
                                                <a class="button_k" href="{{route('TabZamestnanci.uprav', Auth::id())}}">Tu.</a>
                                                </p></li>
                                        <li>
                                            <form action="{{ URL::to('upload', $prof['id']) }}" method="post" enctype="multipart/form-data">
                                                <label><strong>Select image to upload:</strong></label>
                                                <input type="file" name="file" id="file">
                                                <input type="submit" value="Upload" name="submit" style="margin-bottom: 2%">
            ...
            <div class="komentar" >
                ...
                @foreach ($komentare as $kom)
                    <div class="komentare">
                        <div class="autor" >
                            <a href="{{route('iny.profil', $kom->idzamestnanec)}}"><img id="zam-img" src="{{URL::to('/')}}/{{ \App\Http\Controllers\UploadController::VratObrazokZamestnanca($kom['id'])}}" alt="Profilova Fotografia" height="auto" width="100%" style="border-radius: 50%"></a>
                        </div>
